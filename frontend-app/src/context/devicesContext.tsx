...
export interface IDevices {
    devices: Array<types.DeviceInterface>
...
const DevicesProvider = (props: any) => {
    ...
    */
    const {
        ...
        queryFn: async () => await client.getDevices(page, limit, sort, search),
    ...
    */
    ...
    const state: IDevices = {
        ...
        isPreviousData,
        canLoadMore: !isPreviousData && data?.data?.meta?.next_page_url !== null,

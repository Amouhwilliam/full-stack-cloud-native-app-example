...
import {DeviceInterface, PaginatedResponseType, sort_direction, UpsertDeviceInterface} from "./types";
...
export class Devices extends Base {
     ...
     */
    public async getDevices(page: number = 1, limit:number = 5, sort_direction: sort_direction = "desc", search: string = ""): Promise<ResponseTypeDto<PaginatedResponseType>>
    {
        return await this.invoke<PaginatedResponseType>(`devices`,
        {
